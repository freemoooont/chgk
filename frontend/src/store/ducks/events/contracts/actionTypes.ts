...
export interface SetEventsDataActionInterface extends Action<EventsActionType.SET_EVENTS_DATA>{
    type: EventsActionType.SET_EVENTS_DATA
    payload: Event[] | undefined
}

export interface FetchEventsDataActionInterface extends Action<EventsActionType.FETCH_EVENTS_DATA>{
    type: EventsActionType.FETCH_EVENTS_DATA
}

export interface SetEventsErrorMessageActionInterface extends Action<EventsActionType.SET_ERROR_MESSAGE>{
    type: EventsActionType.SET_ERROR_MESSAGE
    payload: Message | undefined
}

export interface SetEventsLoadingStatusActionInterface extends Action<EventsActionType.SET_EVENTS_LOADING_STATUS>{
