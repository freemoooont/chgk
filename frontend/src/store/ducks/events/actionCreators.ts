...
export const setEventsData = (payload: EventsState['data']): SetEventsDataActionInterface => ({
...
export const setErrorMessage = (payload: EventsState['message']): SetEventsErrorMessageActionInterface => ({
    type: EventsActionType.SET_ERROR_MESSAGE,
    payload
});

export const setEventsLoadingStatus = (payload: EventsState['LoadingStatus']): SetEventsLoadingStatusActionInterface => ({
