...
export const setTeamsListData = (payload: TeamsListState['data']): SetTeamsListDataActionInterface => ({
...
export const setErrorMessage = (payload: TeamsListState['message']): SetTeamsListErrorMessageActionInterface => ({
    type: TeamsListActionType.SET_ERROR_MESSAGE,
    payload
})

export const setTeamsListLoadingStatus = (payload: TeamsListState['LoadingStatus']): SetTeamsListLoadingStatusActionInterface => ({
