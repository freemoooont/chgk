...
export interface SetTeamsListDataActionInterface extends Action<TeamsListActionType.SET_TEAMS_LIST_DATA>{
    type: TeamsListActionType.SET_TEAMS_LIST_DATA
    payload: Team[] | undefined
}

export interface FetchTeamsListDataActionInterface extends Action<TeamsListActionType.FETCH_TEAMS_LIST_DATA>{
    type: TeamsListActionType.FETCH_TEAMS_LIST_DATA
}

export interface SetTeamsListErrorMessageActionInterface extends Action<TeamsListActionType.SET_ERROR_MESSAGE>{
    type: TeamsListActionType.SET_ERROR_MESSAGE
    payload: Message | undefined
}

export interface SetTeamsListLoadingStatusActionInterface extends Action<TeamsListActionType.SET_TEAMS_LIST_LOADING_STATUS>{
