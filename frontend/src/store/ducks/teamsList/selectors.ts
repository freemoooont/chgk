...
export const selectTeamsListState = (state: RootState): TeamsListState =>
  state.teamsList;
export const selectTeamsListData = (state: RootState): TeamsListState["data"] =>
  selectTeamsListState(state).data;
export const selectTeamsListStatusLoading = (
  state: RootState
